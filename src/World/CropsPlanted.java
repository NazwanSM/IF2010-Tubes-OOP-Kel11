...
public class CropsPlanted {
    ...
    public CropsPlanted(int x, int y, Seed seed) { 
        ...
        this.seedImage = loadImage("/resource/items/growth/" + crop.getName() + "/phase1.png", uTool);
        this.halfCropImage = loadImage("/resource/items/growth/" + crop.getName() + "/phase2.png", uTool);
        this.fullCropImage = loadImage("/resource/items/growth/" + crop.getName() + "/phase3.png", uTool); 
    }
